...
def BFS(S, G, map, fringe):
    ...
    if(G == S):
        ...
        while(1):
            ...
            #DFS
            # if(left >= 0 and map[left][n[1]] == 0):
            #     fringe.insert(0,map[left][n[1]])
            # if(right<= 100 and map[right][n[1]] == 0):
            #     fringe.insert(0,map[left][n[1]])
            # if(up >= 0 and map[n[0]][up] == 0):
            #     fringe.insert(0,map[n[0]][up])
            # if(down <= 200 and map[n[0]][down] == 0):
            #     fringe.insert(0,map[n[0]][down])
